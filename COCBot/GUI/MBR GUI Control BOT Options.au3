...
Func chkDeleteLogs()
	If GUICtrlRead($chkDeleteLogs) = $GUI_CHECKED Then
		...
		GUICtrlSetState($txtDeleteLogsDays, $GUI_SHOW)
		GUICtrlSetState($lblDeleteLogsDays, $GUI_SHOW)
	Else
		GUICtrlSetState($txtDeleteLogsDays, $GUI_DISABLE)
	    GUICtrlSetState($txtDeleteLogsDays, $GUI_HIDE)
		GUICtrlSetState($lblDeleteLogsDays, $GUI_HIDE)
	EndIf
...
Func chkDeleteTemp()
	If GUICtrlRead($chkDeleteTemp) = $GUI_CHECKED Then
		...
		GUICtrlSetState($txtDeleteTempDays, $GUI_SHOW)
		GUICtrlSetState($lblDeleteTempDays, $GUI_SHOW)
	Else
		GUICtrlSetState($txtDeleteTempDays, $GUI_DISABLE)
		GUICtrlSetState($txtDeleteTempDays, $GUI_HIDE)
		GUICtrlSetState($lblDeleteTempDays, $GUI_HIDE)
	EndIf
...
Func chkDeleteLoots()
	If GUICtrlRead($chkDeleteLoots) = $GUI_CHECKED Then
		...
		GUICtrlSetState($txtDeleteLootsDays, $GUI_SHOW)
		GUICtrlSetState($lblDeleteLootsDays, $GUI_SHOW)
	Else
		GUICtrlSetState($txtDeleteLootsDays, $GUI_DISABLE)
		GUICtrlSetState($txtDeleteLootsDays, $GUI_HIDE)
		GUICtrlSetState($lblDeleteLootsDays, $GUI_HIDE)
	EndIf
...
Func chkAutoStart()
	If GUICtrlRead($chkAutoStart) = $GUI_CHECKED Then
	    ...
	    GUICtrlSetState($txtAutostartDelay, $GUI_SHOW)
	    GUICtrlSetState($lblAutostartSeconds, $GUI_SHOW)
	Else
		GUICtrlSetState($txtAutostartDelay, $GUI_DISABLE)
	    GUICtrlSetState($txtAutostartDelay, $GUI_HIDE)
	    GUICtrlSetState($lblAutostartSeconds, $GUI_HIDE)
	EndIf
...
Func chkDisposeWindows()
	If GUICtrlRead($chkDisposeWindows) = $GUI_CHECKED Then
		...
		For $i = $lblOffset To $cmbDisposeWindowsCond
...
Func chkTotalCampForced()
	If GUICtrlRead($chkTotalCampForced) = $GUI_CHECKED Then
		...
		GUICtrlSetState($txtTotalCampForced, $GUI_SHOW)
	Else
		GUICtrlSetState($txtTotalCampForced, $GUI_DISABLE)
		GUICtrlSetState($txtTotalCampForced, $GUI_HIDE)
	EndIf
...
Func chkSinglePBTForced()
	If GUICtrlRead($chkSinglePBTForced) = $GUI_CHECKED Then
		...
		For $i = $txtSinglePBTimeForced To $lblPBTimeForcedExit1
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
