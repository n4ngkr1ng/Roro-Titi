...
Func chkDBMeetDE()
	If GUICtrlRead($chkDBMeetDE) = $GUI_CHECKED Then
		GUICtrlSetState($txtDBMinDarkElixir, $GUI_ENABLE)
		For $i = $txtDBMinDarkElixir To $picDBMinDarkElixir
...
Func chkDBMeetTrophy()
	If GUICtrlRead($chkDBMeetTrophy) = $GUI_CHECKED Then
		For $i = $txtDBMinTrophy To $picDBMinTrophies
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
		GUICtrlSetState($txtDBMinTrophy, $GUI_ENABLE)

	Else
		For $i = $txtDBMinTrophy To $picDBMinTrophies
		   GUICtrlSetState($i, $GUI_HIDE)
		Next
		GUICtrlSetState($txtDBMinTrophy, $GUI_DISABLE)
	EndIf
...
Func chkDBWeakBase()
	If GUICtrlRead($chkDBWeakBase) = $GUI_CHECKED Then
		...
		For $i = $cmbDBWeakMortar To $picDBWeakWizTower
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
...
Func chkABMeetDE()
	If GUICtrlRead($chkABMeetDE) = $GUI_CHECKED Then
		GUICtrlSetState($txtABMinDarkElixir, $GUI_ENABLE)
		For $i = $txtABMinDarkElixir To $picABMinDarkElixir
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
		GUICtrlSetState($txtABMinDarkElixir, $GUI_DISABLE)
		For $i = $txtABMinDarkElixir To $picABMinDarkElixir
		   GUICtrlSetState($i, $GUI_HIDE)
		Next
	EndIf
...
Func chkABMeetTrophy()
	If GUICtrlRead($chkABMeetTrophy) = $GUI_CHECKED Then
		GUICtrlSetState($txtABMinTrophy, $GUI_ENABLE)
		For $i = $txtABMinTrophy To $picABMinTrophies
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
	    GUICtrlSetState($txtABMinTrophy, $GUI_DISABLE)
		For $i = $txtABMinTrophy To $picABMinTrophies
		   GUICtrlSetState($i, $GUI_HIDE)
		Next
    EndIf
...
Func chkABWeakBase()
	If GUICtrlRead($chkABWeakBase) = $GUI_CHECKED Then
		...
		For $i = $cmbABWeakMortar To $picABWeakWizTower
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
...
Func chkRestartSearchLimit()
	If GUICtrlRead($ChkRestartSearchLimit) = $GUI_CHECKED Then
		...
		For $i = $txtRestartSearchlimit To $lblRestartSearchLimit
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
...
Func chkDBActivateTropies()
	If GUICtrlRead($chkDBActivateTropies) = $GUI_CHECKED Then
		...
		;cmbDBGoldElixir()
		;_GUI_Value_STATE("SHOW", $groupHerosDB)
		For $i = $txtDBTropiesMin To $picDBTrophies
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
...
Func chkDBActivateCamps()
	If GUICtrlRead($chkDBActivateCamps) = $GUI_CHECKED Then
		...
		;cmbDBGoldElixir()
		;_GUI_Value_STATE("SHOW", $groupHerosDB)
		For $i = $lblDBArmyCamps To $txtDBArmyCampsPerc
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
...
Func chkABActivateTropies()
	If GUICtrlRead($chkABActivateTropies) = $GUI_CHECKED Then
		...
		;cmbABGoldElixir()
		;_GUI_Value_STATE("SHOW", $groupHerosAB)
		For $i = $txtABTropiesMin To $picABTrophies
		  GUICtrlSetState($i, $GUI_SHOW)
	    Next
	Else
...
Func chkABActivateCamps()
	If GUICtrlRead($chkABActivateCamps) = $GUI_CHECKED Then
		...
		;cmbABGoldElixir()
		;_GUI_Value_STATE("SHOW", $groupHerosAB)
		For $i = $lblABArmyCamps To $txtABArmyCampsPerc
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
...
Func chkTSActivateTropies()
	If GUICtrlRead($chkTSActivateTropies) = $GUI_CHECKED Then
		...
		;_GUI_Value_STATE("SHOW", $groupSearchTS)
		;cmbTSGoldElixir()
		For $i = $txtTSTropiesMin To $picTSTrophies
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
...
Func chkTSActivateCamps()
	If GUICtrlRead($chkTSActivateCamps) = $GUI_CHECKED Then
		...
		GUICtrlSetState($txtTSArmyCampsPerc, $GUI_ENABLE)
		For $i = $lblTSArmyCamps To $txtTSArmyCampsPerc
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
		;_GUI_Value_STATE("SHOW", $groupSearchTS)
		;cmbTSGoldElixir()
	Else
	    ...
	    GUICtrlSetState($txtTSArmyCampsPerc, $GUI_DISABLE)
		For $i = $lblTSArmyCamps To $txtTSArmyCampsPerc
		   GUICtrlSetState($i, $GUI_HIDE)
		Next
		;_GUI_Value_STATE("HIDE", $groupSearchTS)
...
Func chkDBMeetCollOutside()
	If GUICtrlRead($chkDBMeetCollOutside) = $GUI_CHECKED Then
		...
		GUICtrlSetState($txtDBMinCollOutsidePercent, $GUI_SHOW)
	Else
		GUICtrlSetState($txtDBMinCollOutsidePercent, $GUI_DISABLE)
		GUICtrlSetState($txtDBMinCollOutsidePercent, $GUI_HIDE)
	EndIf
EndFunc   ;==>chkDBMeetCollOutside

Func chkDBSpellsWait()
	If GUICtrlRead($chkDBSpellsWait) = $GUI_CHECKED And GUICtrlRead($chkABSpellsWait) = $GUI_CHECKED Then
		GUICtrlSetState($chkUseSpellsTrainingClose, $GUI_CHECKED)
		GUICtrlSetState($chkUseSpellsTrainingClose, $GUI_DISABLE)
	ElseIf GUICtrlRead($chkDBSpellsWait) = $GUI_CHECKED And GUICtrlRead($chkABSpellsWait) = $GUI_UNCHECKED Then
		GUICtrlSetState($chkUseSpellsTrainingClose, $GUI_CHECKED)
		GUICtrlSetState($chkUseSpellsTrainingClose, $GUI_DISABLE)
	ElseIf GUICtrlRead($chkDBSpellsWait) = $GUI_UNCHECKED And GUICtrlRead($chkABSpellsWait) = $GUI_CHECKED Then
		GUICtrlSetState($chkUseSpellsTrainingClose, $GUI_CHECKED)
		GUICtrlSetState($chkUseSpellsTrainingClose, $GUI_DISABLE)
	ElseIf GUICtrlRead($chkDBSpellsWait) = $GUI_UNCHECKED And GUICtrlRead($chkABSpellsWait) = $GUI_UNCHECKED Then
