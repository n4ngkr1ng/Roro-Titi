...
Func HideBarrackControls()
	...
	GUICtrlSetState($ChktrainBigFirst, $GUI_ENABLE)
...
Func ShowBarrackControls()
	...
	GUICtrlSetState($ChktrainBigFirst, $GUI_DISABLE)
...
Local $correspondancesFactory
If _GUICtrlComboBox_GetCurSel($txtTotalCountSpell) = 0 Then $capaciteRose = 0
If _GUICtrlComboBox_GetCurSel($txtTotalCountSpell) = 1 Then $capaciteRose = 1
If _GUICtrlComboBox_GetCurSel($txtTotalCountSpell) = 2 Then $capaciteRose = 2
If _GUICtrlComboBox_GetCurSel($txtTotalCountSpell) = 3 Then $capaciteRose = 3
If _GUICtrlComboBox_GetCurSel($txtTotalCountSpell) = 4 Then $capaciteRose = 3
If _GUICtrlComboBox_GetCurSel($txtTotalCountSpell) = 5 Then $capaciteRose = 4
If _GUICtrlComboBox_GetCurSel($txtTotalCountSpell) = 6 Then $capaciteRose = 4
If _GUICtrlComboBox_GetCurSel($txtTotalCountSpell) = 7 Then $capaciteRose = 5
If _GUICtrlComboBox_GetCurSel($txtTotalCountSpell) = 8 Then $capaciteRose = 5
...
Func chkBarrackSpell()
	If GUICtrlRead($chkBarrackSpell) = $GUI_CHECKED Then
		For $i = $grpBrewInAdvance To $lblHasteIcon2
			GUICtrlSetState($i, $GUI_SHOW)
		Next
	...
	ElseIf GUICtrlRead($chkBarrackSpell) = $GUI_UNCHECKED Then
		For $i = $grpBrewInAdvance To $lblHasteIcon2
			GUICtrlSetState($i, $GUI_HIDE)
		Next
		For $i = $chkBrewInAdvanceLightningSpell To $chkBrewInAdvanceHasteSpell
			GUICtrlSetState($i, $GUI_UNCHECKED)
		Next
		For $i = $lblTotalSpell To $lblTimesHasteS
...
GUICtrlSetData($txtNumLightningSpell, $capaciteRose)
...
GUICtrlSetData($txtNumLightningSpell, 0)
GUICtrlSetState($txtNumLightningSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumHealSpell, $capaciteRose)
GUICtrlSetState($txtNumHealSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumRageSpell, 0)
GUICtrlSetState($txtNumRageSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumJumpSpell, 0)
...
GUICtrlSetData($txtNumHealSpell, 0)
GUICtrlSetState($txtNumHealSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumRageSpell, $capaciteRose)
GUICtrlSetState($txtNumRageSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumJumpSpell, 0)
GUICtrlSetState($txtNumJumpSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumFreezeSpell, 0)
...
GUICtrlSetData($txtNumRageSpell, 0)
GUICtrlSetState($txtNumRageSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumJumpSpell, $capaciteRose)
GUICtrlSetState($txtNumJumpSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumFreezeSpell, 0)
GUICtrlSetState($txtNumFreezeSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumPoisonSpell, 0)
...
GUICtrlSetData($txtNumJumpSpell, 0)
GUICtrlSetState($txtNumJumpSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumFreezeSpell, $capaciteRose)
GUICtrlSetState($txtNumFreezeSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumPoisonSpell, 0)
GUICtrlSetState($txtNumPoisonSpell, $GUI_ENABLE)
GUICtrlSetData($txtNumEarthSpell, 0)
...
GUICtrlSetData($txtNumFreezeSpell, 0)
GUICtrlSetState($txtNumFreezeSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumPoisonSpell, $capaciteRose * 2)
...
GUICtrlSetData($txtNumPoisonSpell, 0)
GUICtrlSetState($txtNumPoisonSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumEarthSpell, $capaciteRose * 2)
GUICtrlSetState($txtNumEarthSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumHasteSpell, 0)
GUICtrlSetState($txtNumHasteSpell, $GUI_DISABLE)
EndIF
...
GUICtrlSetData($txtNumEarthSpell, 0)
GUICtrlSetState($txtNumEarthSpell, $GUI_DISABLE)
GUICtrlSetData($txtNumHasteSpell, $capaciteRose * 2)
GUICtrlSetState($txtNumHasteSpell, $GUI_DISABLE)
EndIF
EndFunc
