...
Local $x = 14, $y = 45
	...
	$y += 22
		...
		$picAtkElixirCollectors = GUICtrlCreateIcon($pIconLib, $eIcnCollector, $x + 52, $y - 6, 24, 24)
		$y += 26
		$chkAtkGoldMines = GUICtrlCreateCheckbox(GetTranslated(631,13, -1), $x, $y, -1, 18)
			GUICtrlSetState(-1, $GUI_CHECKED)
			GUICtrlSetOnEvent(-1, "chkAtkGoldMines")
		$picAtkGoldMines = GUICtrlCreateIcon($pIconLib, $eIcnMine, $x + 52, $y - 6, 24, 24)
		...
		$chkAtkDarkDrills = GUICtrlCreateCheckbox(GetTranslated(631,13, -1), $x, $y, -1, 18)
			...
			GUICtrlSetState(-1, $GUI_CHECKED)
		$picAtkDarkDrills = GUICtrlCreateIcon($pIconLib, $eIcnDrill, $x + 52, $y - 6, 24, 24)
