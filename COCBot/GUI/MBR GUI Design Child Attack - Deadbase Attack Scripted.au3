...
;	 $x -= 15
		...
		$y += 80
		$grpScriptSpeedDB = GUICtrlCreateGroup("CSV Deployment Speed", $x, $y, 230, 110)
			$chkCSVSpeedStaticDB = GUICtrlCreateRadio("Static", $x + 5, $y + 20, 55, 17)
			$txtTip =  "Choose a static CSV Deployment Speed"
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "chkCSVSpeedStaticDB")
			GUICtrlSetState(-1, $GUI_UNCHECKED)
			$chkCSVSpeedVariableDB = GUICtrlCreateRadio("Variable", $x + 70, $y + 20, 60, 17)
			$txtTip =  "Choose a random CSV Deployment Speed in a specific range"
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "chkCSVSpeedVariableDB")
			GUICtrlSetState(-1, $GUI_CHECKED)
			$lbltxtSelectedSpeedTxtDB = GUICtrlCreateLabel("Speed :", $x + 10, $y + 62, 40, 25)
			GUICtrlSetState(-1, $GUI_HIDE)
			$lbltxtSelectedSpeedDB = GUICtrlCreateLabel("Normal", $x + 55, $y + 62, 40, 25)
				GUICtrlSetTip(-1, "Increase or decrease the speed at which the CSV attack script deploys troops and waves.")
				GUICtrlSetState(-1, $GUI_HIDE)
			$sldSelectedSpeedDB = GUICtrlCreateSlider($x + 98, $y + 60, 125, 25, BitOR($TBS_TOOLTIPS, $TBS_AUTOTICKS))
				GUICtrlSetTip(-1, "Increase or decrease the speed at which the CSV attack script deploys troops and waves.")
				...
				GUICtrlSetState(-1, $GUI_HIDE)
			$lbltxtSelectedSpeedTxtMinDB = GUICtrlCreateLabel("Minimum ", $x + 10, $y + 52, 45, 25)
			GUICtrlSetState(-1, $GUI_SHOW)
			$lbltxtSelectedSpeedMinDB = GUICtrlCreateLabel("0.75 X", $x + 60, $y + 52, 40, 25)
				GUICtrlSetTip(-1, "Increase or decrease the minimum speed at which the CSV attack script deploys troops and waves.")
				GUICtrlSetState(-1, $GUI_SHOW)
			$sldSelectedSpeedMinDB = GUICtrlCreateSlider($x + 98, $y + 50, 125, 25, BitOR($TBS_TOOLTIPS, $TBS_AUTOTICKS))
				GUICtrlSetTip(-1, "Increase or decrease the minimum speed at which the CSV attack script deploys troops and waves.")
				_GUICtrlSlider_SetTipSide(-1, $TBTS_BOTTOM)
				_GUICtrlSlider_SetTicFreq(-1, 1)
				GUICtrlSetLimit(-1, 12, 0) ; change max/min value
				GUICtrlSetData(-1, 3) ; default value
				GUICtrlSetOnEvent(-1, "sldSelectedSpeedMinDB")
				GUICtrlSetState(-1, $GUI_SHOW)
			$lbltxtSelectedSpeedTxtMaxDB = GUICtrlCreateLabel("Maximum ", $x + 10, $y + 82, 45, 25)
			GUICtrlSetState(-1, $GUI_SHOW)
			$lbltxtSelectedSpeedMaxDB = GUICtrlCreateLabel("1.5 X", $x + 60, $y + 82, 40, 25)
				GUICtrlSetTip(-1, "Increase or decrease the maximum speed at which the CSV attack script deploys troops and waves.")
				GUICtrlSetState(-1, $GUI_SHOW)
			$sldSelectedSpeedMaxDB = GUICtrlCreateSlider($x + 98, $y + 80, 125, 25, BitOR($TBS_TOOLTIPS, $TBS_AUTOTICKS))
				GUICtrlSetTip(-1, "Increase or decrease the maximum speed at which the CSV attack script deploys troops and waves.")
				_GUICtrlSlider_SetTipSide(-1, $TBTS_BOTTOM)
				_GUICtrlSlider_SetTicFreq(-1, 1)
				GUICtrlSetLimit(-1, 12, 0) ; change max/min value
				GUICtrlSetData(-1, 6) ; default value
				GUICtrlSetOnEvent(-1, "sldSelectedSpeedMaxDB")
				GUICtrlSetState(-1, $GUI_SHOW)
