...
Func chkBalanceDR()
	If GUICtrlRead($chkUseCCBalanced) = $GUI_CHECKED Then
		...
		For $i = $cmbCCDonated To $cmbCCReceived
...
Func chkAttackNow()
	If GUICtrlRead($chkAttackNow) = $GUI_CHECKED Then
		...
		For $i = $lblAttackNow To $lblAttackNowSec
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
		$iChkAttackNow = 0
...
Func chkTHSnipeBeforeDBEnable()
	If GUICtrlRead($chkTHSnipeBeforeDBEnable) = $GUI_CHECKED Then
		...
		For $i = $lblTHSnipeBeforeDBTiles To $cmbTHSnipeBeforeDBScript
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
...
Func chkTHSnipeBeforeLBEnable()
	If GUICtrlRead($chkTHSnipeBeforeLBEnable) = $GUI_CHECKED Then
		...
		For $i = $lblTHSnipeBeforeLBTiles To $cmbTHSnipeBeforeLBScript
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
...
Func chkSearchReduction()
	If GUICtrlRead($chkSearchReduction) = $GUI_CHECKED Then
		GUICtrlSetState($txtSearchReduceCount, $GUI_ENABLE)
		GUICtrlSetState($txtSearchReduceGold, $GUI_ENABLE)
		GUICtrlSetState($txtSearchReduceElixir, $GUI_ENABLE)
		GUICtrlSetState($txtSearchReduceGoldPlusElixir, $GUI_ENABLE)
		GUICtrlSetState($txtSearchReduceDark, $GUI_ENABLE)
		GUICtrlSetState($txtSearchReduceTrophy, $GUI_ENABLE)
		For $i = $lblSearchReduceCount To $picSearchReduceTrophy
		   GUICtrlSetState($i, $GUI_SHOW)
		Next
	Else
		GUICtrlSetState($txtSearchReduceCount, $GUI_DISABLE)
		GUICtrlSetState($txtSearchReduceGold, $GUI_DISABLE)
		GUICtrlSetState($txtSearchReduceGoldPlusElixir, $GUI_DISABLE)
		GUICtrlSetState($txtSearchReduceElixir, $GUI_DISABLE)
		GUICtrlSetState($txtSearchReduceDark, $GUI_DISABLE)
		GUICtrlSetState($txtSearchReduceTrophy, $GUI_DISABLE)
		For $i = $lblSearchReduceCount To $picSearchReduceTrophy
		   GUICtrlSetState($i, $GUI_HIDE)
		Next
	EndIf
