...
Local $x = 15, $y = 45
	$grpControls = GUICtrlCreateGroup(GetTranslated(610,1, "Halt Attack"), $x - 10, $y - 20, 440, 100)
		...
		$cmbBotCommand = GUICtrlCreateCombo("", $x + 20, $y - 3, 100, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetData(-1, GetTranslated(610,3, "Halt Attack") & "|" & GetTranslated(610,4, "Stop Bot") & "|" & GetTranslated(610,5, "Close Bot") & "|" & GetTranslated(610,6, "Close CoC+Bot") & "|" & GetTranslated(610,7, "Shutdown PC") & "|" & GetTranslated(610,8, "Sleep PC") & "|" & GetTranslated(610,9, "Reboot PC")& "|" & "Random break", "Random break")
			GUICtrlSetState (-1, $GUI_DISABLE)
			GUICtrlSetOnEvent(-1, "cmbBotCommand")
		...
		$cmbBotCond = GUICtrlCreateCombo("", $x + 175, $y - 3, 160, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			...
			GetTranslated(610,32, "W/Shield (Only stay online)") & "|" & _
			"Bot running for 8 to 9 hours", "Bot running for 8 to 9 hours")
	...
	$x += 90
		...
		$txtRestartGold = GUICtrlCreateInput("50000", $x + 30, $y, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	...
	$x += 90
		...
		$txtRestartElixir = GUICtrlCreateInput("100000", $x + 30, $y, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	...
	$x += 90
		...
		$txtRestartDark = GUICtrlCreateInput("1000", $x + 30, $y, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
