...
Global Enum $eIcnArcher = 1, $eIcnDonArcher, $eIcnBalloon, $eIcnDonBalloon, $eIcnBarbarian, $eIcnDonBarbarian, $eIcnKingAbility, $eIcnBuilder, $eIcnCC, $eIcnGUI, $eIcnDark, $eIcnDragon, $eIcnDonDragon, $eIcnDrill, $eIcnElixir, $eIcnCollector, $eIcnFreezeSpell, $eIcnGem, $eIcnGiant, $eIcnDonGiant, _
		...
		$eIcnTree, $eIcnProfile, $eIcnCCRequest, $eIcnTelegram, $eIcnTiles, $eIcnXbow3, $eIcnBark, $eIcnDailyProgram, $eIcnLootCart, $eIcnSleepMode, $eIcnTH11, $eIcnTrainMode, $eIcnSleepingWarden, $eIcnSoleil, $eIcnFoudre, $eIcnPieuvre, $eIcnChrono, $eIcnNotification, $eIcnCrown, $eIcnDodo, $eIcnCalendrier, $eIcnPeople, $eIcnEpee, $eIcnParam, $eIcnSwitch
...
Global $iEnableSpellsWait[$iModeCount], $iTotalSpellSpace = 0, $bFullArmySpells = False, $IsWaitingForHeroesSpells = 0, $IsTonotifyOneTime = 0
...
Global $isldSelectedCSVSpeed[$iModeCount], $isldSelectedCSVSpeedMin[$iModeCount], $isldSelectedCSVSpeedMax[$iModeCount], $iCSVSpeeds[13]
Global $ichkCSVSpeedStaticDB, $ichkCSVSpeedVariableDB, $ichkCSVSpeedStaticAB, $ichkCSVSpeedVariableAB
Global $ResultCSVSpeedDeploy, $TxtSpeedDeploy
$isldSelectedCSVSpeed[$DB] = 4
$isldSelectedCSVSpeed[$LB] = 4
$isldSelectedCSVSpeedMin[$DB] = 3
$isldSelectedCSVSpeedMax[$DB] = 6
$isldSelectedCSVSpeedMin[$LB] = 3
$isldSelectedCSVSpeedMax[$LB] = 6
$iCSVSpeeds[0] = .1
$iCSVSpeeds[1] = .25
$iCSVSpeeds[2] = .5
$iCSVSpeeds[3] = .75
...
Global $ichkUseSpellsTrainingClose = 0
...
;Collecteurs exposes
Global $ichkDBMeetCollOutside, $iDBMinCollOutsidePercent, $iCollOutsidePercent
