...
Func Train()
	...
	If $iAtkAlgorithm[$DB] <> 2 Or $iAtkAlgorithm[$LB] <> 2 Then

		If $iChktrainBigFirst = 0 Then
		; 11 sets différents au hasard, plutôt les petits d'abords
		Local $tempTroopGroup0[10][3] = [["Arch", 1, 1], ["Barb", 0, 1], ["Wall", 4, 2], ["Gobl", 3, 1], ["Heal", 7, 14], ["Pekk", 9, 25], ["Giant", 2, 5], ["Ball", 5, 5], ["Wiza", 6, 4], ["Drag", 8, 20]]
		Local $TempTroopGroup1[10][3] = [["Wall", 4, 2], ["Barb", 0, 1], ["Arch", 1, 1], ["Gobl", 3, 1], ["Giant", 2, 5], ["Heal", 7, 14], ["Pekk", 9, 25], ["Ball", 5, 5], ["Wiza", 6, 4], ["Drag", 8, 20]]
		Local $tempTroopGroup2[10][3] = [["Arch", 1, 1], ["Barb", 0, 1], ["Wall", 4, 2], ["Gobl", 3, 1], ["Heal", 7, 14], ["Pekk", 9, 25], ["Giant", 2, 5], ["Ball", 5, 5], ["Wiza", 6, 4], ["Drag", 8, 20]]
		Local $tempTroopGroup3[10][3] = [["Barb", 0, 1], ["Giant", 2, 5], ["Arch", 1, 1], ["Wall", 4, 2], ["Gobl", 3, 1], ["Heal", 7, 14], ["Pekk", 9, 25], ["Ball", 5, 5], ["Wiza", 6, 4], ["Drag", 8, 20]]
		Local $tempTroopGroup4[10][3] = [["Barb", 0, 1], ["Pekk", 9, 25], ["Arch", 1, 1], ["Wall", 4, 2], ["Giant", 2, 5], ["Gobl", 3, 1], ["Heal", 7, 14], ["Ball", 5, 5], ["Wiza", 6, 4], ["Drag", 8, 20]]
		Local $tempTroopGroup5[10][3] = [["Gobl", 3, 1], ["Barb", 0, 1], ["Pekk", 9, 25], ["Arch", 1, 1], ["Wall", 4, 2], ["Giant", 2, 5], ["Heal", 7, 14], ["Ball", 5, 5], ["Wiza", 6, 4], ["Drag", 8, 20]]
		Local $tempTroopGroup6[10][3] = [["Heal", 7, 14], ["Gobl", 3, 1], ["Barb", 0, 1], ["Pekk", 9, 25], ["Arch", 1, 1], ["Wall", 4, 2], ["Giant", 2, 5], ["Ball", 5, 5], ["Wiza", 6, 4], ["Drag", 8, 20]]
		Local $tempTroopGroup7[10][3] = [["Wiza", 6, 4], ["Heal", 7, 14], ["Gobl", 3, 1], ["Barb", 0, 1], ["Pekk", 9, 25], ["Arch", 1, 1], ["Wall", 4, 2], ["Giant", 2, 5], ["Ball", 5, 5], ["Drag", 8, 20]]
		Local $tempTroopGroup8[10][3] = [["Wiza", 6, 4], ["Arch", 1, 1], ["Barb", 0, 1], ["Wall", 4, 2], ["Gobl", 3, 1], ["Heal", 7, 14], ["Pekk", 9, 25], ["Giant", 2, 5], ["Ball", 5, 5], ["Drag", 8, 20]]
		Local $tempTroopGroup9[10][3] = [["Wall", 4, 2], ["Wiza", 6, 4], ["Arch", 1, 1], ["Barb", 0, 1], ["Gobl", 3, 1], ["Heal", 7, 14], ["Pekk", 9, 25], ["Giant", 2, 5], ["Ball", 5, 5], ["Drag", 8, 20]]
		Local $tempTroopGroup10[10][3] = [["Wall", 4, 2], ["Gobl", 3, 1], ["Wiza", 6, 4], ["Arch", 1, 1], ["Barb", 0, 1], ["Heal", 7, 14], ["Pekk", 9, 25], ["Giant", 2, 5], ["Ball", 5, 5], ["Drag", 8, 20]]

		$TroopGroup = Eval("TempTroopGroup" & Random(0, 10, 1))
		Local $tempTroopName[UBound($TroopGroup, 1)]
		$TroopName = $tempTroopName
		...
		ElseIf $iChktrainBigFirst = 1 Then ; les gros en premiers 1 des 2 sets au hasard

		SetLog("Train Big First Mode", $COLOR_PURPLE)
		Local $TempTroopGroup0[10][3] = [["Drag", 8, 20], ["Pekk", 9, 25], ["Ball", 5, 5], ["Heal", 7, 14], ["Wiza", 6, 4], ["Giant", 2, 5], ["Wall", 4, 2], ["Gobl", 3, 1] ,["Arch", 1, 1], ["Barb", 0, 1]]
		Local $TempTroopGroup1[10][3] = [["Ball", 5, 5], ["Drag", 8, 20], ["Pekk", 9, 25], ["Heal", 7, 14], ["Wiza", 6, 4], ["Giant", 2, 5], ["Wall", 4, 2], ["Gobl", 3, 1] ,["Arch", 1, 1], ["Barb", 0, 1]]

		$TroopGroup = Eval("TempTroopGroup" & Random(0, 1, 1)) ; ici tu ponderes Random(0, 1, 1) par Random(0, x, 1) avec x = nombre de $TempTroopGroup - 1
		Local $tempTroopName[UBound($TroopGroup, 1)]
		$TroopName = $tempTroopName
	...
	If $fullarmy = True Then
		...
		PushMsg("CampFull") ;Telegram[Surbiks]
	EndIf
	...
	If $icmbTroopComp = 8 Then
		...
		While isBarrack()
			...
			If $FirstStart Then
				...
				If $currentForecast > (Number($iTxtForecastPause, 3) - 0.1) Then
				$icount = 0
				...
				WEnd
				ElseIf $iChkDontRemoveredzone = 0 And ($currentForecast < (Number($iTxtForecastPause, 3) - 0.1)) Then
				$icount = 0
				While Not _ColorCheck(_GetPixelColor(599, 202 + $midOffsetY, True), Hex(0xD0D0C0, 6), 20) ; while not disappears  green arrow
					If Not (IsTrainPage()) Then Return
					Click(568, 177 + $midOffsetY, 10, 0, "#0273") ; Remove Troops in training
