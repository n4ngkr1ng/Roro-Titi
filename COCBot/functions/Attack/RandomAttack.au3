...
Func RandomAttack()
	...
	; determinate |$TimeToStop| a randomize run the Bot from x hours to x Hours
	If $icmbBotCond = 22 and $RandomTimer Then
		$sTimerRandomHalt = TimerInit()
		$TimeToStop = random(510, 569, 1)* 60000 ; 60000 = 1 Minute | 8h30 hours to 9h30 Hours (510-569)
		$RandomTimer = False
		...
		SetLog("The bot will take a break in " & $Dummy_Hours & " hours and " & $Dummy_Minutes & " minutes", $COLOR_BLUE)
		Return False
	EndIf
